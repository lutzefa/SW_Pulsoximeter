...
/*TODO: Status LED der Messung auf EXP oben links auschalten.*/
/*******************************************************************************
 ...
 *      ->ist auch in biometric.c enthalten, funktioniert anscheinend. ob man
 *          das so macht und das schön ist, kein plan.
 *          habe es hier einfach auch mal drin gelassen
*/
...
/*TODO: ifdef LW_REDandGREEN_LED_ENABLE um LED ein und auszuschalten*/
#ifdef LW_REDandGREEN_LED_ENABLE
	/***************************************************************************//**
